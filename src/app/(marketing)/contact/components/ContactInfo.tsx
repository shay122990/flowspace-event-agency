    ...
    >
      <div className="space-y-4">
        ...
        <div className="grid gap-3">
          <a
            href={`mailto:${email}`}
            className="group flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3 text-white md:text-gray-600 transition hover:border-white/20"
          >
            <span className="grid h-10 w-10 place-items-center rounded-lg bg-white/8">
          ...
          <div className="group flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3 text-white md:text-gray-600">
            <span className="grid h-10 w-10 place-items-center rounded-lg bg-white/8">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2">
          {socials.map((s) => (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-xs font-medium text-white md:text-gray-600 transition hover:border-white/20"
            >
