...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Mobile bar */}
      <div className="container mx-auto flex items-center justify-between py-3 px-2 lg:hidden">
        <button
          type="button"
        ...
        <Link
          href="/proposal"
          className="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium bg-black/10 text-black hover:bg-purple-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-black/30"
        >
          Proposal
        </Link>
      </div>
